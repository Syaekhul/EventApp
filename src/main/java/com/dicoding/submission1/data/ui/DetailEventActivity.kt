...
import com.dicoding.submission1.data.response.Event
...
class DetailEventActivity : AppCompatActivity() {
    ...
    private fun setDetailEventData(eventDetail: Event) {
        ...
        val originalFormat =
            SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault()) // Format asli dari endTime
        val desiredFormat =
            SimpleDateFormat("MMM dd, yyyy", Locale.getDefault()) // Format yang diinginkan
        try {
            val date =
